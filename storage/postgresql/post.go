...
func (s *TaskStorage) CreatePost(ctx context.Context, post entity.Post) (int64, error) {
	var id int64
	err := s.db.QueryRow(ctx, `
        INSERT INTO posts (title, created_at, expiration, duration, chat_id, msg_id)
        VALUES ($1, $2, $3, $4, $5, $6, $7)
		RETURNING id;
    `, post.UserID, post.Text, post.CreatedAt, post.Expiration, post.Duration, post.ChatID, post.MsgID).Scan(&id)
	return id, err
}
